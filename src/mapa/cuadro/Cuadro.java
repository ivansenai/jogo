...
public class Cuadro { // Não precisa ser abstrata se você instanciar Cuadros diretamente
    ...
    public final int x; // Coordenada X do quadro na folha de sprites
    public final int y; // Coordenada Y do quadro na folha de sprites
    ...
    public static final Cuadro VACIO = new Cuadro(Sprite.VACIO, true); // Opcional, pode ser solido ou não, depende da sua lógica
    public static final Cuadro ASFALTO = new Cuadro(Sprite.ASFALTO, false);
    ...
    public Cuadro(Sprite sprite, boolean solido) {
        this.x = sprite.getLado(); // x e y do quadro na folha de sprites (não usado, mas pode ser útil)
        this.y = sprite.getLado(); // x e y do quadro na folha de sprites
        this.sprite = sprite;
        this.solido = solido;
    }

    public void mostrar(int x, int y, Pantalla pantalla) {
        pantalla.mostrarCuadro(x << 5, y << 5, this); // << 5 é o mesmo que * 32
    }
